...
__author__ = "Rami Ayoub, Declan Foshaug, Adam Rickert"
...
[]
    ...
    for i in infile:
        ...
        if student_health == int(word_list[4]):
            ...
            word_list[3]), 'Absences': int(word_list[5]), 'G1': int(word_list[6]), 'G2': int(word_list[7]), 'G3': int(word_list[8])}
...
>>> add_average([{'Age': 16, 'StudyTime': 2.0, 'Failures': 0, 'Health': 3, 'Absences': 12, 'G1': 5, 'G2': 5, 'G3': 5}, {another element}])
[{'Age': 16, 'StudyTime': 2.0, 'Failures': 0, 'Health': 3, 'Absences': 12, 'G1': 5, 'G2': 5, 'G3': 5, 'G_Avg': 5.0}, {another element}]

>>> add_average([{'Age': 15, 'StudyTime': 3.0, 'Failures': 0, 'Health': 5, 'Absences': 2, 'G1': 15, 'G2': 14, 'G3': 15}, {another element}])
[{'Age': 15, 'StudyTime': 3.0, 'Failures': 0, 'Health': 5, 'Absences': 2, 'G1': 15, 'G2': 14, 'G3': 15, 'G_Avg': 14.67}, {another element}]
    """
    average_value = 0
    new_student_list = []
